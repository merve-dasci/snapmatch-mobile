...
const PERFECT_FOR_WORDS = [
  { text: "düğünler", gradient: "var(--home-grad-1)" },
  { text: "mezuniyet geceleri", gradient: "var(--home-grad-2)" },
  { text: "kurumsal etkinlikler", gradient: "var(--home-grad-3)" },
  { text: "festival anları", gradient: "var(--home-grad-4)" },
  { text: "gece partileri", gradient: "var(--home-grad-5)" },
  { text: "okul törenleri", gradient: "var(--home-grad-6)" },
];
  ...
  return (
    <div className="scroll-wrap text-[var(--text-main)]">
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-[0.82rem] font-bold border transition-all duration-300 cursor-pointer ${isActive
                ...
                >
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-black ${isActive ? "bg-white text-[var(--color-blue-dark)]" : "bg-black/10 text-[var(--text-muted)]"
                    }`}>{step.num}</span>
                        ...
                        {isScanningThis && (
                          <div className="absolute inset-0 bg-purple-500/20 backdrop-blur-[1px] flex flex-col justify-between overflow-hidden">
                            <motion.div
                              ...
                              className="w-full h-0.5 bg-purple-500 shadow-[0_0_8px_var(--glow-purple)]"
                            />
                          </div>
                        )}
                      </div>
                    ...
                    >
                      ...
                      {selectedGuest && selectedGuest !== "upload" && (
                        <div className="absolute inset-0 pointer-events-none">
                          ...
                          <div className={`absolute border-2 border-emerald-500 rounded-md shadow-[0_0_12px_rgba(52,211,153,0.5)] ${photo.bboxClass || "top-[25%] left-[35%] w-[30%] h-[30%]"
                            }`}>
      ...
      <GlassModal
        ...
        title={selectedPhoto?.title || "Görsel Önizleme"}
        width="max-w-[90vw]"
        height="max-h-[85vh]"
        noPadding
      >
        <div className="relative flex flex-col bg-slate-950/20 text-white">
          <img
